...
--
-- Locals do not survive require(), so any colour hyprland.lua reads has to be
-- a global. Only green and base are consumed today (general.col.*); drop the
-- local from another one when you start using it.
